...
{
    public partial class Form_PictureExport : Form
    {
      
        //#region ExcelAddIn_Graphics Import
        ...
        #region Init
        public Form_PictureExport(IntPtr objHandle)
        {
            _objHandle = objHandle;
        }

        public Form_PictureExport()
        {
            InitializeComponent();
        }
        ...
        {
            One = 1, Two = 2, Three = 3, Four = 4, Five = 5, Six = 6, Seven = 7, Eight = 8, Nine = 9, Ten = 10, twelve = 12, twentyfour = 24
        }
